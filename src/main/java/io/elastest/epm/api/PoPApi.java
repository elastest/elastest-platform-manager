...
public interface PopApi {
    ...
    @ApiOperation(value = "Returns a PoP.", notes = "Returns the PoP with the given ID. Returns all its details.", response = PoP.class, tags={ "PoP", })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Successful operation", response = PoP.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = PoP.class),
        @ApiResponse(code = 403, message = "Forbidden", response = PoP.class),
    ...
    @RequestMapping(value = "/pop/{id}",
        ...
        method = RequestMethod.GET)
    ResponseEntity<PoP> getPoPById(@ApiParam(value = "ID of PoP", required = true) @PathVariable("id") String id);


    @ApiOperation(value = "Registers a new PoP", notes = "Registers a new Point-of-Presence represented by a PoP", response = PoP.class, tags={ "PoP", })
    @ApiResponses(value = {
    ...
    ResponseEntity<PoP> registerPoP(@ApiParam(value = "Defintion of a PoP which defines a Point-of-Presence used to host resources", required = true) @RequestBody PoP body) throws AdapterException;


    @ApiOperation(value = "Unregisters a PoP.", notes = "Unregisters the PoP that matches with a given ID.", response = String.class, tags={ "PoP", })
    @ApiResponses(value = {
    ...
    ResponseEntity<String> unregisterPoP(@ApiParam(value = "ID of PoP", required = true) @PathVariable("id") String id) throws AdapterException, NotFoundException;


    @ApiOperation(value = "Updates a PoP.", notes = "Updates an already registered PoP.", response = PoP.class, tags={ "PoP", })
    @ApiResponses(value = {
    ...
    ResponseEntity<PoP> updatePoP(@ApiParam(value = "ID of PoP", required = true) @PathVariable("id") String id, @ApiParam(value = "PoP object that needs to be updated.", required = true) @RequestBody PoP body);
