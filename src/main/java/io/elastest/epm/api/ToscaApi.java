...
public interface ToscaApi {
    ...
    @ApiOperation(value = "Deploys a Tosca template.", notes = "The TOSCA template defines VDUs, Networks and the PoPs where to allocate the virtual resources", response = ResourceGroup.class, tags={ "TOSCA", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/tosca",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<ResourceGroup> deployToscaTemplate(@ApiParam(value = "TOSCA formatted template", required = true) @RequestBody String serviceTemplate) throws Exception;
