...
public interface ResourceGroupApi {
  ...
  @ApiOperation(
    value = "Creates a new Resource Group.",
    notes = "Creates a new Resource Group and allocates the defined resources in the defined PoPs.",
  ...
  @ApiResponses(
    value = {
      @ApiResponse(
        code = 200,
        message = "Resource Group creation OK",
        response = ResourceGroup.class
      ),
  ...
  ResponseEntity<ResourceGroup> createResourceGroup(
      @ApiParam(
            value =
  ...
  @ApiOperation(
    ...
    notes = "Deletes the Resource Group that matches with a given ID.",
  ...
  @ApiResponses(
    value = {
      @ApiResponse(
        code = 200,
        message = "ResourceGroup deleted successfully",
        response = String.class
      ),
  ...
  ResponseEntity<String> deleteResourceGroup(
  ...
  @ApiOperation(
    value = "Returns all Resource Groups.",
    notes = "Returns all Resource Groups with all details.",
    response = ResourceGroup.class,
  ...
  @ApiOperation(
    value = "Returns a Resource Group.",
    notes = "Returns the Resource Group with the given ID. Returns all its details.",
    response = ResourceGroup.class,
    tags = {
      "ResourceGroup",
    }
  ...
  ResponseEntity<ResourceGroup> getResourceGroupById(
      @ApiParam(value = "ID of ResourceGroup", required = true) @PathVariable("id") String id)
      throws NotFoundException;

  @ApiOperation(
    value = "Updates a ResourceGroup.",
    notes = "Updates an existing ResourceGroup.",
    response = ResourceGroup.class,
    tags = {
      "ResourceGroup",
    }
  ...
  ResponseEntity<ResourceGroup> updateResourceGroup(
      @ApiParam(value = "ID of ResourceGroup", required = true) @PathVariable("id") String id,
