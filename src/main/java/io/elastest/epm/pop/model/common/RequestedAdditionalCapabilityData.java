...
public class RequestedAdditionalCapabilityData extends NfvEntity {
  ...
  @NotEmpty private String requestedAdditionalCapabilityName;

  /*Indicates whether the requested additional capability is mandatory for successful operation.*/
  @NotEmpty private boolean supportMandatory;
  ...
  @NotEmpty private Set<KeyValuePair> targetPerformanceParameters;
