...
public class VirtualCompute extends NfvEntity {
  ...
  @NotEmpty private String computeId;
  ...
  @NotEmpty private VirtualCpu virtualCpu;

  /*The virtual memory of the compute. See clause 8.4.3.5.*/
  @NotEmpty private VirtualMemory virtualMemory;
  ...
  @NotEmpty private Set<VirtualStorage> virtualDisks;
