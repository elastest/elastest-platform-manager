...
public final class OperationHandlerGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<Empty, Empty> METHOD_CHECK_STATUS =
  ...
  public abstract static class OperationHandlerImplBase implements io.grpc.BindableService {
    ...
    /** */
    public void checkStatus(Empty request, io.grpc.stub.StreamObserver<Empty> responseObserver) {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
              METHOD_CHECK_STATUS,
              asyncUnaryCall(new MethodHandlers<Empty, Empty>(this, METHODID_CHECK_STATUS)))
          .build();
    }
  }
  ...
  public static final class OperationHandlerFutureStub
    ...
    /** */
    public com.google.common.util.concurrent.ListenableFuture<Empty> checkStatus(Empty request) {
      ...
      switch (methodId) {
        ...
        case METHODID_CHECK_STATUS:
          serviceImpl.checkStatus(
              (Empty) request, (io.grpc.stub.StreamObserver<Empty>) responseObserver);
          break;
        default:
