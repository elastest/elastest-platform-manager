...
public final class OperationHandlerGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ResourceIdentifier,
      StringResponse> METHOD_CHECK_IF_CONTAINER_EXISTS =
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ResourceIdentifier,
          StringResponse> METHOD_CHECK_IF_CONTAINER_RUNNING =
      io.grpc.MethodDescriptor.<ResourceIdentifier, StringResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class OperationHandlerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void remove(ResourceIdentifier request,
    ...
    /**
     */
    public void stopContainer(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<Empty> responseObserver) {
    ...
    /**
     */
    public void checkIfContainerExists(ResourceIdentifier request,
    ...
    /**
     */
    public void checkIfContainerRunning(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<StringResponse> responseObserver) {
    ...
    /**
     */
    public void startContainer(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<Empty> responseObserver) {
  ...
  public static final class OperationHandlerStub extends io.grpc.stub.AbstractStub<OperationHandlerStub> {
    ...
    public void checkIfContainerExists(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<StringResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_CHECK_IF_CONTAINER_EXISTS, getCallOptions()), request, responseObserver);
    }
    ...
    public void checkIfContainerRunning(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<StringResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_CHECK_IF_CONTAINER_RUNNING, getCallOptions()), request, responseObserver);
    }
    ...
    public void startContainer(ResourceIdentifier request,
        io.grpc.stub.StreamObserver<Empty> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_START_CONTAINER, getCallOptions()), request, responseObserver);
    }
  ...
  public static final class OperationHandlerBlockingStub extends io.grpc.stub.AbstractStub<OperationHandlerBlockingStub> {
    ...
    public Empty startContainer(ResourceIdentifier request) {
      return blockingUnaryCall(
          getChannel(), METHOD_START_CONTAINER, getCallOptions(), request);
    }
    ...
    /**
     */
    public Empty checkStatus(Empty request) {
      return blockingUnaryCall(
  ...
  public static final class OperationHandlerFutureStub extends io.grpc.stub.AbstractStub<OperationHandlerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<StringResponse> checkIfContainerExists(
        ResourceIdentifier request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<StringResponse> checkIfContainerRunning(
        ResourceIdentifier request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Empty> checkStatus(
        Empty request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_REMOVE:
          serviceImpl.remove((ResourceIdentifier) request,
              (io.grpc.stub.StreamObserver<Empty>) responseObserver);
          break;
        case METHODID_STOP_CONTAINER:
          serviceImpl.stopContainer((ResourceIdentifier) request,
              (io.grpc.stub.StreamObserver<Empty>) responseObserver);
          break;
        case METHODID_CHECK_IF_CONTAINER_EXISTS:
          serviceImpl.checkIfContainerExists((ResourceIdentifier) request,
              (io.grpc.stub.StreamObserver<StringResponse>) responseObserver);
          break;
        case METHODID_CHECK_IF_CONTAINER_RUNNING:
          serviceImpl.checkIfContainerRunning((ResourceIdentifier) request,
              (io.grpc.stub.StreamObserver<StringResponse>) responseObserver);
          break;
        case METHODID_START_CONTAINER:
          serviceImpl.startContainer((ResourceIdentifier) request,
              (io.grpc.stub.StreamObserver<Empty>) responseObserver);
          break;
