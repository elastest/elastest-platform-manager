...
public final class OperationHandlerGrpc {
  ...
  public static final io.grpc.MethodDescriptor<Empty,
      ...
      io.grpc.MethodDescriptor.<Empty, Status>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<InstallMessage,
      StringResponse> METHOD_CREATE_CLUSTER =
      io.grpc.MethodDescriptor.<InstallMessage, StringResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "OperationHandler", "CreateCluster"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              InstallMessage.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              StringResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class OperationHandlerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createCluster(InstallMessage request,
        io.grpc.stub.StreamObserver<StringResponse> responseObserver) {
  ...
  public static final class OperationHandlerBlockingStub extends io.grpc.stub.AbstractStub<OperationHandlerBlockingStub> {
    ...
    /**
     */
    public StringResponse createCluster(InstallMessage request) {
      return blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_CREATE_CLUSTER:
          serviceImpl.createCluster((InstallMessage) request,
              (io.grpc.stub.StreamObserver<StringResponse>) responseObserver);
          break;
        default:
